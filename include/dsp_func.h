...
q15_t *apply_window(int32_t *buffer, const uint32_t length);
...
#define CONST_LEVEL  (1000) // mV
#define AMP1         (20)   // mV
#define AMP2         (20)   // mV
#define AMP3         (50)   // mV
#define AMP_T        (500)  // mV - minimal amp for target freq
...
#define VFREQ_T (0)  // Hz/sec - increasing speed for TARGET freq
